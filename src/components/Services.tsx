...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      features: [
        "Pregadores pneumáticos profissionais",
        "Grampeadores de alta precisão",
  ...
  const applications = [
    { name: "Paletes", description: "Fixação resistente para logística" },
    { name: "Móveis", description: "Acabamento profissional em marcenaria" },
    { name: "Estofados", description: "Fixação precisa em estofaria" },
    { name: "Embalagens", description: "Soluções para indústria de embalagens" },
    { name: "Construção Civil", description: "Aplicações em obras e reformas" },
    { name: "Indústria Automotiva", description: "Componentes e acabamentos" }
  ];
          ...
          <div className="bg-muted rounded-2xl p-8 md:p-12 animate-fade-in-up">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {applications.map((app, index) => (
                <div key={index} className="bg-background rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300 animate-scale-in"
            ...
            <div className="text-center">
              <Button 
                ...
                className="bg-gradient-primary hover:bg-primary-hover px-8 py-4 text-lg font-semibold transition-all duration-300 hover:shadow-glow"
              >
                Solicitar Orçamento
          ...
          <div className="text-center mt-16 animate-fade-in-up">
            <div className="bg-gradient-hero rounded-2xl p-8 md:p-12 text-white">
              ...
              <Button 
                ...
                size="lg"
                onClick={scrollToContact}
                className="border-white/60 text-white hover:bg-white/10 hover:border-white px-8 py-4 text-lg font-semibold"
              >
                Fale Conosco Agora
              </Button>
            </div>
